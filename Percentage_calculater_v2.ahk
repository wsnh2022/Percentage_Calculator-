...
Gui, Color, Black, 2C3539
Gui, +AlwaysOnTop +ToolWindow +Border
Gui Font, s11 CLime, Consolas
Gui Add,Text, x10 y10 w200 h16 +0x200,% "What is         % of" ;Long text box
Gui Add,Edit, x70 y08 w65 h20 gLabel0 vPer1 Right            		;1st Input
Gui Add,Edit, x180 y08 w55 h20 gLabel0 vPer2 Right            		;2nd Input
...
;-----------------------------------------------------------------------------------
Gui Show,w350 h160,Percentage_Finder                                       						;Show centred > in body
Return
